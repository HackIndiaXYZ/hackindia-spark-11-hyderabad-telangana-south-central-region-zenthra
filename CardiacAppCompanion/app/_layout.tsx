...
function RootLayoutNav() {
  ...
  const { isDemoMode, liveData } = useContext(AppContext);
  ...
  return (
    <ThemeProvider value={theme === 'dark' ? DarkTheme : DefaultTheme}>
      ...
      <Stack screenOptions={{ headerShown: false, animation: 'fade', contentStyle: { backgroundColor: colors.background }, headerStyle: { backgroundColor: colors.background } }}>
        <Stack.Screen name="index" />
        <Stack.Screen name="(tabs)" />
        <Stack.Screen name="guardian-dashboard" />
        <Stack.Screen name="alert" options={{ presentation: 'fullScreenModal' }} />
        <Stack.Screen name="graph" options={{ presentation: 'modal', title: 'Clinical Trends' }} />
